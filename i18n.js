const translations = {
  fr: {
    ...
    "hero.subtitle": "Étudiante en Informatique",
    "about.title": "À Propos de Moi",
    "about.text":
    "Je suis plus à l'aise quand je fabrique quelque chose que quand je l'explique. Alors voilà ce que j'ai fait.",
  ...
  en: {
    ...
    "about.text":
      "Curious and motivated student with a strong foundation in programming (Java, Python, HTML/JS) and Linux. Rigorous and organized, I fully invest myself in my assigned tasks.",
  ...
  ar: {
    ...
    "nav.contact": "تواصل",
    "hero.title": "فاطمة مرزوق",
    "hero.subtitle": "طالبة علوم حاسوب (21 سنة)",
    "about.title": "نبذة عني",
    "about.text":
      "طالبة شغوفة ومتحمسة، أمتلك أساساً قوياً في البرمجة وتقنية لينكس. دقيقة ومنظمة، وأكرس نفسي بالكامل للمهام الموكلة إلي.",
    ...
    "experience.3":
      "ساعية بريد متعددة المهام (La Poste) - ديسمبر 2023-أغسطس 2024",
...
function setLanguage(lang) {
  ...
  window.dispatchEvent(
    new CustomEvent("languageChanged", { detail: { isRtl } }),
  );
}
